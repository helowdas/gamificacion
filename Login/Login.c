...
void login(char nombre_usuario[], int clave){
    ...
    if(verificar_usuario(nombre_usuario) == 1){
        printf("\n ---SESION INICIADA----\n");
...
/*ESTE ES MAIN ES PARA PROBAR LAS FUNCIONES, DE SER NECEARIO SE PUEDE USAR EN UN ARCHIVO APARTE.*/
int main(){
    menu_usuario(); 
